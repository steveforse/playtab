...
export { inspectMusicXmlDuration, changeMusicXmlDuration, insertMusicXmlBeat, createMusicXmlTriplet, inspectMusicXmlTriplet, removeMusicXmlTriplet } from './editor/durations';
...
export { removeMusicXmlGrace, inspectMusicXmlGraceGroup, applyMusicXmlGraceGroup, addMusicXmlGraceGroup, removeMusicXmlGraceGroup, graceBeatPlacement, isAfterGraceGroup } from './editor/grace';
export type { GraceRemoval, GraceMember, GraceNoteSpec, GraceBeatSpec, GraceGroupInfo, GracePlacement } from './editor/grace';
...
export type { ChordQuality, ChordRoot, ChordSpelling, AnchorKind, AnchorItem, AnchorInfo, LyricSyllabic, BeatLyric } from './editor/text';
